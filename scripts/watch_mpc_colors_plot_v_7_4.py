#!/usr/bin/env python3
"""
watch_mpc_colors_plot_v7_4.py
3I/ATLAS (C/2019 Y4) — MPC Color Evolution + Brightness Timeline Composite
...
def plot_colors_and_brightness(pairs, df):
    ...
    # --- Filter timeline bars (only g,r,o) ---
    ...
    # --------------------------------------------------
    # Lower plot: g-band Brightness Evolution
    # --------------------------------------------------
    ...
    plt.tight_layout()
    plt.savefig("I3_Color_Trend_v7_4.png", dpi=250)
    plt.close(fig)
    print("✅ Saved: I3_Color_Trend_v7_4.png")
