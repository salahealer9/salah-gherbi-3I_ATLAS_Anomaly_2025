#!/usr/bin/env bash
# ============================================================
# protect_atlas_v2_4.sh
# Salah-Eddin Gherbi — Cryptographic Archival Script (v2.4)
# ============================================================
...
# ------------------------------------------------------------
{
  ...
  for f in \
    ...
    I3_ATLAS_v2_4_Analysis.pdf \
    README_PROOF_v2_4.md \
    RUN_LOG.md; do
...
{
  echo "| ${STAMP} | \`${HASH}\` | ${PROOF} | proof_bundle/${ZIP} | ${VERSION} – post-perihelion + spectral transition protected |"
} >> "$LOG"
