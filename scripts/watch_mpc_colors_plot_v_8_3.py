#!/usr/bin/env python3
"""
watch_mpc_colors_plot_v8_3.py
3I/ATLAS (C/2019 Y4) — MPC Color Evolution, Solar Baselines,
Filter Activity, Δ Analysis, and Provenance-Linked Blockchain Proof.

Each run generates UTC-dated outputs, ORCID-verified author info,
and a self-contained OpenTimestamps manifest for long-term reproducibility.
